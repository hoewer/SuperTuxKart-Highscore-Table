...
function displayRow($trackName, $icon, $reverse, $mode, $laps, $username, $result, $misc = 0) {
    ...
    if (empty($_GET['venue'])) {
        ...
        echo "<td><a href='?venue={$icon}&amp;laps={$laps}&amp;mode={$mode}&amp;reverse={$reverse}&amp;unique={$unique}'>Mehr</a></td>";
    }
    echo "</tr>\n";
}
?>
...
<body style="background-color:#F5EFE0">
            ...
            <tr>
                <td style='padding-top: 0.1em;padding-bottom: 0.1em;'>
                    <div class="records_form" style='text-align: left;'>
                        <b>Strecke:</b><br>
                        <select name="venue">
                            <option value="">W&auml;hle Track...</option>
                ...
                <td style='padding-top: 0.1em;padding-bottom: 0.1em;'>
                    <div class="records_form" style='text-align: left;'>
                        ...
                        <input type="radio" name="mode" value="time-trial" <?= $_GET['mode'] == "time-trial" ? "checked" : "" ?>> Zeitrennen
                        <input type="radio" name="mode" value="" <?= isset($_GET['mode']) && $_GET['mode'] == "" ? "checked" : "" ?>> Alle
                    </div>
                </td>
                <td style='padding-top: 0.1em;padding-bottom: 0.1em;'>
                    <div class="records_form" style='text-align: left;'>
                        <b>Neuste Rekorde:</b><br>
                        <input type="radio" name="recent" value="true" <?= $_GET['recent'] == "true" ? "checked" : "" ?>> Ja
                        <input type="radio" name="recent" value="false" <?= $_GET['recent'] == "false" ? "checked" : "" ?>> Nein
                    </div>
                </td>
            ...
            <tr>
                <td style='padding-top: 0.1em;padding-bottom: 0.1em;'>
                    <div class="records_form" style='text-align: left;'>
                        <b>Runden:</b><br>
                        <select name="laps">
                            <option value="">Anzahl Runden...</option>
                ...
                <td style='padding-top: 0.1em;padding-bottom: 0.1em;'>
                    <div class="records_form" style='text-align: left;'>
                        ...
                        <input type="radio" name="reverse" value="reverse" <?= $_GET['reverse'] == "reverse" ? "checked" : "" ?>> Umgekehrt
                        <input type="radio" name="reverse" value="" <?= isset($_GET['reverse']) && $_GET['reverse'] == "" ? "checked" : "" ?>> Alle
                    </div>
                </td>
                <td style='padding-top: 0.1em;padding-bottom: 0.1em;'>
                    <div class="records_form" style='text-align: left;'>
                        <b>Unique Players:</b><br>
                        <input type="radio" name="unique" value="true" <?= $_GET['unique'] == "true" ? "checked" : "" ?>> Ja
                        <input type="radio" name="unique" value="false" <?= $_GET['unique'] == "false" ? "checked" : "" ?>> Nein
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="marginauto box95 tablebox">
        <table>
            <tr>
                <th><div class="recordheading">Strecke<img class="headingicon" src="./media/track.png"></div></th>
                <th><div class="recordheading">Icon<img class="headingicon" src="./media/icon.png"></div></th>
                <th><div class="recordheading">Richtung<img class="headingicon" src="./media/direction.png"></div></th>
                <th><div class="recordheading">Modus<img class="headingicon" src="./media/mode.png"></div></th>
                <th><div class="recordheading">Runden<img class="headingicon" src="./media/laps.png"></div></th>
                <th><div class="recordheading">Fahrer<img class="headingicon" src="./media/username.png"></div></th>
                <th><div class="recordheading">Rekord<img class="headingicon" src="./media/result.png"></div></th>
                <?php if (empty($_GET['venue']) && $_GET['recent'] == "true"): ?>
                    <th><div class="recordheading">Datum<img class="headingicon" src="./media/calendar.png"></div></th>
                <?php endif; ?>
                <?php if (empty($_GET['venue'])): ?>
                    <th><div class="recordheading">Mehr</div></th>
                <?php endif; ?>
            </tr>
